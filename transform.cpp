...
namespace egc {
	...
	mat3 rotate(float angle) {
		mat3 result;
		result.at(0, 0) = cos(angle*PI/180.0);
		result.at(1, 0) = sin(angle*PI / 180.0);
		result.at(0, 1) = -sin(angle*PI / 180.0);
		result.at(1, 1) = cos(angle*PI / 180.0);
		return result;
	}
	...
	mat4 rotateX(float angle) {
		mat4 result;
		result.at(1, 1) = cos(angle*PI / 180.0);
		result.at(2, 1) = sin(angle*PI / 180.0);
		result.at(1, 2) = -sin(angle*PI / 180.0);
		result.at(2, 2) = cos(angle*PI / 180.0);
		return result;
	}
	mat4 rotateY(float angle) {
		mat4 result;
		result.at(0, 0) = cos(angle*PI / 180.0);
		result.at(0, 2) = sin(angle*PI / 180.0);
		result.at(2, 0) = -sin(angle*PI / 180.0);
		result.at(2, 2) = cos(angle*PI / 180.0);
		return result;
	}
